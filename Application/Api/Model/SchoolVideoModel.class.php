    ...
    */
    public function getListByCate($map=array(),$page,$per_page,$is_recommend){        
        ...
        if(!empty($is_recommend)){
            ...
            $list = $this->where($map)->page($page,$per_page)->order($order)->field('id,title,cover_url,guests_id,views,times,cate_title,is_vip,big_cover_url,category,charge_standard')->select();
        }
