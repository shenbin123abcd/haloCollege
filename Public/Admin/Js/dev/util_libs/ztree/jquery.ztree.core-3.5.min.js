...
(function($){
	...
	view = {
		...
		makeDOMNodeNameBefore: function(html, setting, node) {
			...
			dataid = view.makeNodeDataId(node),
			datahtml = dataid == '' ? '' : "data-id='" + dataid + "'";
			...
			html.push("<a id='", node.tId, consts.id.A, "' class='", consts.className.LEVEL, node.level,"' treeNode", consts.id.A," onclick=\"", (node.click || ''),
				"\" ", ((url != null && url.length > 0) ? "href='" + url + "'" : ""), datahtml, " target='",view.makeNodeTarget(node),"' style='", fontStyle.join(''),
				"'");
