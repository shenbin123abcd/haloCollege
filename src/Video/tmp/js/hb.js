...
;(function (window, document) {
    ...
    (function (window, document, undefined) {
        ...
        var weui = function () {
            var _alert = function _alert(options) {
                ...
                var alertHtmlStr = '' + '<div class="weui_dialog_alert" >' + '<div class="weui_mask"></div>' + '<div class="weui_dialog" style="display: none;" >' + '<div class="weui_dialog_hd"><strong class="weui_dialog_title">' + settings.title + '</strong></div>' + '<div class="weui_dialog_bd">' + settings.content + '</div>' + '<div class="weui_dialog_ft">' + '<a href="javascript:;" class="weui_btn_dialog primary">' + settings.btn + '</a>' + '</div>' + ' </div>' + ' </div>' + '';
            ...
            var toast = function toast(msg) {
                var toastHtmlStr = '' + '<div class="weui_msg_toast" >' + '<div class="weui_mask_transparent"></div>' + '<div class="weui_toast">' + '<i class="weui_icon_toast"></i>' + '<p class="weui_toast_content">' + msg + '</p>' + '</div>' + '</div>' + '';
    ...
    (function (window, document, undefined) {
        ...
        var checkPhone = function checkPhone(num) {
    ...
    (function (window, document, undefined) {
        ...
        var storeWithExpiration = {
            ...
            get: function get(key) {
                var info = haloBear.store.get(key);
                if (!info) {
                    return null;
                }
        ...
        haloBear.storage = storeWithExpiration;
    })(window, document);
    ...
    (function (window, document, undefined) {
        ...
        var interval = function interval(fun, delay, count, afterCount) {
