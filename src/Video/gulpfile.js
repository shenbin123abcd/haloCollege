...
gulp.task('haloIcon', function () {
    return gulp.src('app/css/lib/ux_*/*iconfont.*')
        ...
        .pipe(gulp.dest('../../Public/Home/Video/css'))
});
...
gulp.task('images', function () {
    ...
    // .pipe(plugins.imagemin())
        .pipe(plugins.rev())
        .pipe(gulp.dest('../../Public/Home/Video/images'))
...
gulp.task('copy:view', function () {
    ...
    return gulp
        ...
        .pipe(htmlFilter)
        .pipe(plugins.cdnizer({
            defaultCDNBase: "http://"+devip()[0]+":19001/app",
            //defaultCDNBase: "../",
            allowRev: true,
            allowMin: true,
            files: [
                ...
                {
                    file: 'js/**/*.js',
                    cdn: "http://"+devip()[0]+":19001/tmp/js/${ filename }"
                },
                'images/**/*.{jpg,png,mp3,mp4}',
            ]
        }))
